...
import { getModels, getActiveModel } from "../../Reducers/modelReducer";
...
class Editor extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.getActiveModel(this.props.currentUser.id);
    setTimeout(() => {
      this.setState({
      ...
      <div className={classes.Editor}>
        ...
        <div className={classes.ContainerEdit}>
          <div className={classes.AutoMarkup}>
            <div className={classes.AutoMarkup__Text}>Авторазметка</div>
          ...
          <div className={classes.Palette}>
            <div className={classes.Brush__Text}>Кисть</div>
            <Panel
              color={this.state.color}
              brush={this.state.brush}
              onColorChange={(color) => {
...
export default compose(
  connect(mapStateToProps, { getModels, getActiveModel }),
  withRouter
)(Editor);
